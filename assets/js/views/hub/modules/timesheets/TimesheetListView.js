...
], function ($, _, Backbone, BootstrapDatepicker, Erp, UserNav2View,
             TimesheetMainSidebarView, TimesheetManagerBottomBarView, TimesheetListFilterBarView,
             TimesheetSearchWidgetView, TimesheetListViewByCollab, TimesheetListViewBySite, listTemplate, I18nObject) {
        var erp = window.Erp,
            fxDuration = 400,
                ...
                render: function () {
                    ...
                    // list of variables and their respective translations
                        vars = {
                            ...
                            collab_tab_title: I18nObject.collab_tab_title,
                            site_tab_title: I18nObject.site_tab_title
                        };
